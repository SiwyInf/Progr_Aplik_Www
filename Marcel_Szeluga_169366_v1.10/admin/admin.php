...
function listaProduktow($link) {
    ...
    echo "<table border='1'><tr><th>ID</th><th>Tytuł</th><th>Cena netto</th><th>Ilość</th><th>Status</th><th>Akcje</th></tr>";
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<a href='admin.php?action=delete_product&id={$row['id']}' onclick=\"return confirm('Czy na pewno chcesz usunąć ten produkt?')\">Usuń</a></td></tr>";
    }
